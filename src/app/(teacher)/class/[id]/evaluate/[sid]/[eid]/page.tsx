        ...
        <ClassWrap>
            ...
            <div className={styles.evaluate_info}>
                <div className={styles.level_wrap}>
                    ...
                    <div className={styles.level_date}>{evaluate.dates[evaluate.dates.length - 1]}</div>
                    <div className={styles.level_content}>{(!first)?`${evaluate.content[evaluate.content.length - 1]}%`:`0%`}</div>
                </div>
