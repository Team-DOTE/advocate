...
const Report = forwardRef<HTMLDivElement, ReportProps>(({ content }, ref) => {
  return (
      ...
      <div>
        <div className={styles.page}>
          ...
          <div>
            ...
            <table className={styles.table}>
              <tr>
                <th scope="col" style={{ width: "25%" }} className={styles.th}>
                  이름
                </th>
                <td
                  scope="col"
        ...
        <div className={styles.page}>
          ...
          <div>
            ...
            <table className={styles.table}>
              <tr>
                <th className={styles.th}>가족 특성 및 지원이 필요한 내용</th>
